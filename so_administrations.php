...
**/
function so_vider_tables($nom_meta_base_version) {
	# quelques exemples
	...
	sql_delete("spip_versions",              sql_in("objet", array('abusobjet')));
	sql_delete("spip_versions_fragments",    sql_in("objet", array('abusobjet')));
	sql_delete("spip_forum",                 sql_in("objet", array('abusobjet')));
